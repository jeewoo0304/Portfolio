...
export const experienceData = [
  ...
  },
  {
    ...
    period: "2021.08 - 재학중",
    description:
      "자료구조, 운영체제, 디지털논리회로, 파이썬, 선형대수, 이산수학, HTML5 등 수료",
  },
  {
    type: "경력",
    title: "UX 부문 - 대리",
  ...
  },
  {
    ...
    description:
      "웹/앱/반응형 제작, 웹솔루션 제작, 유지보수, 퍼블리싱 가이드 작업 및 검수, HTML5 교체작업 등\n퍼블팀 면접 및 교육, PM, PL, 인사관리",
  },
  {
    type: "교육원",
    title: "프론트엔드 양성과정",
...
export const getExperienceTypeLabel = (type) => {
  switch (type) {
    case "경력":
      return "Career";
    case "학력":
...
/** 타임라인 타입 → CSS 클래스명 (경력/학력/교육원) */
export const getExperienceTypeClass = (type) => {
  switch (type) {
    case "경력":
      return "career";
    case "학력":
