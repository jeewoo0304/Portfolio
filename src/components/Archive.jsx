...
const Archive = () => {
  ...
  const archiveData = [
    ...
    {
      id: 2,
      title: "전북은행 / 외국인금융플랫폼 브라보코리아 구축",
      period: "구축 6개월",
      contribution: "REACT, JAX",
    ...
    },
    {
      id: 14,
      title: "IR GO / 주식정보 웹앱",
      period: "작업 소요기간 구현 약 1주 / 리뉴얼 약 6주",
